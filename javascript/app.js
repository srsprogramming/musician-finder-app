  ...
  var finishData = [];
      ...
      var zip2 = 75230;
      var url1 =
        "http://maps.googleapis.com/maps/api/geocode/json?address=" + zip1;
      var url2 =
        "http://maps.googleapis.com/maps/api/geocode/json?address=" + zip2;
          ...
          function lastFMajaxCall() {
            ...
            //for loop to build html
              for (var count = 0; count < finishData.length; count++) {
                var newMusician = $("<div>");
                var newText = $("<ul>");
                newText.html("<li>"+ finishData[count].firstName +" "+ finishData.lastName+ "<li></li>"+"<li>Musical Taste: "+finishData[count].musicalTaste +"</li><li>"+ finishData[count].instruments +"</li><li>Top Track "+
                  count + 1 + ". " + response.toptracks.track[count].name
